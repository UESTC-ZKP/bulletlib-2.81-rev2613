...
class examplePINVOKE {
  ...
  public static extern void myArrayCopy(HandleRef jarg1, HandleRef jarg2, int jarg3);

  [DllImport("example", EntryPoint="CSharp_myArraySwap")]
  public static extern void myArraySwap(HandleRef jarg1, HandleRef jarg2, int jarg3);
}
