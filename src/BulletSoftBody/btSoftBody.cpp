									   ...
									   bool bcheckexist)
{
	...
	m_linkNodeIndex.push_back(node0);
	m_linkNodeIndex.push_back(node1);
}
...
void			btSoftBody::appendFace(int node0,int node1,int node2,Material* mat)
{
	...
	f.m_ra		=	AreaOf(	f.m_n[0]->m_x,
		f.m_n[1]->m_x,
		f.m_n[2]->m_x);	
	m_faceNodeIndex.push_back(node0);
	m_faceNodeIndex.push_back(node1);
	m_faceNodeIndex.push_back(node2);
	m_bUpdateRtCst=true;
}
