...
#ifdef SOFTLIBIMPORT
class  __declspec(dllimport) btSoftBodyRigidBodyCollisionConfiguration : public btDefaultCollisionConfiguration
#else
#ifdef SWIG
class  btSoftBodyRigidBodyCollisionConfiguration : public btDefaultCollisionConfiguration
#else
class  __declspec(dllexport) btSoftBodyRigidBodyCollisionConfiguration : public btDefaultCollisionConfiguration
#endif
