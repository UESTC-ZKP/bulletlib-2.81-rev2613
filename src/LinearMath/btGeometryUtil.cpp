...
bool btGeometryUtil::isInside(const btAlignedObjectArray<btVector3>& vertices, const btVector3& planeNormal, btScalar	margin)
{
	// not implement for bullet, add a return for swig interface.
