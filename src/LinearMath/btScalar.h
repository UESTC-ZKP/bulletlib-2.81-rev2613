...
//			#pragma warning(disable:4786) // Disable the "debug name too long" warning
			  ...
			  #define ATTRIBUTE_ALIGNED64(a) a
			  #define ATTRIBUTE_ALIGNED128(a) a
              #define BULLET_MATH_EXPORT
              #define BULLET_COLLISION_EXPORT
              #define BULLET_DYNAMICS_EXPORT
              #define BULLET_SOFT_EXPORT
              #define BULLET_OPENGLSUPPORT_EXPORT
		#else
			  ...
			  #define ATTRIBUTE_ALIGNED128(a) __declspec (align(128)) a
			   #ifdef MATHLIBIMPORT
					   #define BULLET_MATH_EXPORT __declspec(dllimport)
			   #else
					   #define BULLET_MATH_EXPORT __declspec(dllexport)
			   #endif

			   #ifdef COLLISIONLIBIMPORT
					   #define BULLET_COLLISION_EXPORT __declspec(dllimport)
			   #else
					   #define BULLET_COLLISION_EXPORT __declspec(dllexport)
			   #endif

			   #ifdef DYNAMICSLIBIMPORT
               ...
               #ifdef SOFTLIBIMPORT
					  #define BULLET_SOFT_EXPORT __declspec(dllimport)
			   #else
					   #define BULLET_SOFT_EXPORT __declspec(dllexport)
			   #endif

               #ifdef OPENGLSUPPORTLIBIMPORT
					  #define BULLET_OPENGLSUPPORT_EXPORT __declspec(dllimport)
			   #else
					   #define BULLET_OPENGLSUPPORT_EXPORT __declspec(dllexport)
			   #endif
...
struct BULLET_MATH_EXPORT btTypedObject
{
